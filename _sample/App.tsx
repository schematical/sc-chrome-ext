...
const App: React.FC = () => {
    ...
    } catch (err)
 {
  ...
  }, [productImageFile, sceneImage, selectedProduct, additionalPrompt]);
           ...
           {isLoading ? (
             ...
             <div className="w-full max-w-2xl animate-fade-in">
                ...
                <div className="w-full mt-4">
                    <label htmlFor="additional-prompt" className="block text-sm font-medium text-zinc-700 mb-2 text-left">
                        Add more context (optional)
                    </label>
                    <textarea
                        id="additional-prompt"
                        rows={3}
                        className="block w-full rounded-lg border-zinc-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-3 bg-zinc-50 text-zinc-800"
                        placeholder="e.g., 'Make the product smaller', 'Place it next to the lamp', 'Change the color to blue'"
